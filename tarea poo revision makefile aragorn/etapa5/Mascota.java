...
public class Mascota {
    ...
    */
    ...
    public void Inicio(){ //constructor para crear una mascota parametrizada
        //this.nombre="Garfield"; //nombre de la mascota
        this.edad=0;
        this.salud=50;
        this.energia=50;
        this.felicidad=50;
    ...
    public void Dormir(double horas) {
        // Aumenta la energía de la mascota según las horas que ha dormido
        this.energia += horas * 10; // Suponiendo que la energía aumenta en 10 unidades por hora de sueño
        if (this.energia > 100) {
            this.energia = 100; // La energía no puede superar el límite de 100
        }
        // Ajusta la salud de la mascota según las horas que ha dormido
        // La salud aumenta más al principio del sueño y disminuye gradualmente
        if (horas <= 2) {
            this.salud += horas * 5; // Aumento rápido de salud para las primeras 2 horas
        } else {
            this.salud += 2 * 5 + (horas - 2) * 2; // Aumento más lento para las horas restantes
        }
        // Verifica si la salud supera el límite máximo de 100
        this.salud = (this.salud > 100) ? 100 : this.salud;
        System.out.println(this.nombre + " ha dormido " + horas + " horas");
    }
    public void Dormir(){
        this.energia=100;
    ...
    public void Estado() {
      ...
      //condicional simple para poner como limite que la energia, felicidad y salud minimo pueden ser 0.
